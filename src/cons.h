...
#define CUTE_CONS_REPORT_EXCP_HEAD   " #EXCP"
#define CUTE_CONS_REPORT_EXCP_FMT    "%6u"
#define CUTE_CONS_REPORT_EXCP_WIDTH  ((int) \
				      sizeof(CUTE_CONS_REPORT_EXCP_HEAD) - 1)
